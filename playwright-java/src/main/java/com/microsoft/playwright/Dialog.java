...
/**
 * {@code Dialog} objects are dispatched by page via the {@link Page#onDialog Page.onDialog()}
 * event.
 *
 ...
 * }</pre>
 *
 * <p> <strong>NOTE:</strong> Dialogs are dismissed automatically, unless there is a {@link Page#onDialog Page.onDialog()}
 * listener. When listener is present, it **must** either {@link Dialog#accept Dialog.accept()} or
