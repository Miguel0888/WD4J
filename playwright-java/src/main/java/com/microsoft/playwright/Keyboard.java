 ...
 * Keyboard#type Keyboard.type()}, which takes raw characters and generates proper {@code
 * keydown}, {@code keypress}/{@code input}, and {@code keyup} events on your page.
 *
 * <p> For finer control, you can use {@link Keyboard#down Keyboard.down()}, {@link
 * Keyboard#up Keyboard.up()}, and {@link Keyboard#insertText
...
public interface Keyboard {
   ...
   * will be sent with that modifier active. To release the modifier key, use {@link Keyboard#up
   * Keyboard.up()}.
   *
   * <p> After the key is pressed once, subsequent calls to {@link Keyboard#down Keyboard.down()} will
   * have <a href="https://developer.mozilla.org/en-US/docs/Web/API/KeyboardEvent/repeat">repeat</a> set to true. To release
   * the key, use {@link Keyboard#up Keyboard.up()}.
   *
   ...
   * }</pre>
   *
   * <p> Shortcut for {@link Keyboard#down Keyboard.down()} and {@link
   ...
   *
   * <p> To press a special key, like {@code Control} or {@code ArrowDown}, use {@link Keyboard#press
   * Keyboard.press()}.
   *
   * <p> <strong>Usage</strong>
   * <pre>{@code
