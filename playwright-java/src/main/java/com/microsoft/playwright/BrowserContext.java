 ...
 * Browser#newContext Browser.newContext()} method. Non-persistent browser contexts don't write
...
public interface BrowserContext extends AutoCloseable {
   ...
   * also fire for popup pages. See also {@link Page#onPopup Page.onPopup()} to receive events about
   ...
   *
   * <p> In order to intercept and mutate requests, see {@link BrowserContext#route
   * BrowserContext.route()} or {@link Page#route Page.route()}.
   */
   ...
   * with {@link BrowserContext#onRequestFinished BrowserContext.onRequestFinished()} event and not
   * with {@link BrowserContext#onRequestFailed BrowserContext.onRequestFailed()}.
   */
   ...
   *
   * <p> <strong>NOTE:</strong> {@link BrowserContext#route BrowserContext.route()} will not intercept requests intercepted by
   ...
   * }</pre>
   *
   * <p> Page routes (set up with {@link Page#route Page.route()}) take precedence over browser context
   * routes when request matches both handlers.
   *
   * <p> To remove a route with its handler you can use {@link BrowserContext#unroute
   ...
   * </ul>
   *
   * <p> <strong>NOTE:</strong> {@link Page#setDefaultNavigationTimeout Page.setDefaultNavigationTimeout()} and {@link
   * Page#setDefaultTimeout Page.setDefaultTimeout()} take priority over {@link
   ...
   *
   * <p> <strong>NOTE:</strong> {@link Page#setDefaultNavigationTimeout Page.setDefaultNavigationTimeout()}, {@link
   * Page#setDefaultTimeout Page.setDefaultTimeout()} and {@link
   * BrowserContext#setDefaultNavigationTimeout BrowserContext.setDefaultNavigationTimeout()} take
   * priority over {@link BrowserContext#setDefaultTimeout BrowserContext.setDefaultTimeout()}.
   *
   ...
   * with page-specific extra HTTP headers set with {@link Page#setExtraHTTPHeaders
   ...
   *
   * <p> <strong>NOTE:</strong> {@link BrowserContext#setExtraHTTPHeaders BrowserContext.setExtraHTTPHeaders()} does not
   ...
   * }</pre>
   *
   * <p> <strong>NOTE:</strong> Consider using {@link BrowserContext#grantPermissions BrowserContext.grantPermissions()} to
  ...
  void unrouteAll();
  /**
   * Removes a route created with {@link BrowserContext#route BrowserContext.route()}. When {@code
   ...
   * @param url A glob pattern, regex pattern or predicate receiving [URL] used to register a routing with {@link
   * BrowserContext#route BrowserContext.route()}.
   * @param handler Optional handler function used to register a routing with {@link BrowserContext#route
