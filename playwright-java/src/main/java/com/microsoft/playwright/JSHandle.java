 ...
 * Page#evaluateHandle Page.evaluateHandle()} method.
 * <pre>{@code
 ...
 * JSHandle#dispose JSHandle.dispose()}. JSHandles are auto-disposed when their origin frame gets
 * navigated or the parent context gets destroyed.
 *
 * <p> JSHandle instances can be used as an argument in {@link Page#evalOnSelector
 * Page.evalOnSelector()}, {@link Page#evaluate Page.evaluate()} and {@link
 * Page#evaluateHandle Page.evaluateHandle()} methods.
 */
