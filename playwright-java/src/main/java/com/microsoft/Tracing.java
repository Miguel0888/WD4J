...
import com.microsoft.options.Location;
...
public interface Tracing {
  class StartOptions {
     ...
     * tracesDir} directory specified in {@link BrowserType#launch BrowserType.launch()}. To specify
     * the final trace zip file name, you need to pass {@code path} option to {@link Tracing#stop
  ...
  class StartChunkOptions {
     ...
     * If specified, intermediate trace files are going to be saved into the files with the given name prefix inside the {@code
     * tracesDir} directory specified in {@link BrowserType#launch BrowserType.launch()}. To specify
     * the final trace zip file name, you need to pass {@code path} option to {@link Tracing#stopChunk
  ...
  class GroupOptions {
     ...
     * Tracing#group Tracing.group()} call.
     */
  ...
  class StopChunkOptions {
    /**
     * Export trace collected since the last {@link Tracing#startChunk Tracing.startChunk()} call into
