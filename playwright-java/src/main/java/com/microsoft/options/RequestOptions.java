...
//        String implementationClassName = "com.microsoft.playwright.impl.RequestOptionsImpl";
        ...
        // Statische Methode `create()` über Reflection aufrufen
        return (RequestOptions) clazz.getDeclaredMethod("create").invoke(null);
      } catch (ClassNotFoundException e) {
          throw new RuntimeException("Implementation class not found: " + e.getMessage(), e);
      } catch (NoSuchMethodException e) {
          throw new RuntimeException("Static method 'create()' not found in class: " + e.getMessage(), e);
      } catch (Exception e) {
          throw new RuntimeException("Failed to invoke static create() method", e);
      }
    }
  /**
