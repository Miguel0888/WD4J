...
import com.microsoft.options.ClientCertificate;
import com.microsoft.options.HttpCredentials;
import com.microsoft.options.Proxy;
...
public interface APIRequest {
  class NewContextOptions {
    /**
     * Methods like {@link APIRequestContext#get APIRequestContext.get()} take the base URL into
     ...
     * obtained via {@link BrowserContext#storageState BrowserContext.storageState()} or {@link
     * APIRequestContext#storageState APIRequestContext.storageState()}. Either a path to the file
     * with saved storage, or the value returned by one of {@link BrowserContext#storageState
     * BrowserContext.storageState()} or {@link APIRequestContext#storageState
