...
import com.microsoft.options.MouseButton;
...
public interface Mouse {
  ...
  /**
   * Shortcut for {@link Mouse#move Mouse.move()}, {@link Mouse#down
   * Mouse.down()}, {@link Mouse#up Mouse.up()}.
   *
  ...
  /**
   * Shortcut for {@link Mouse#move Mouse.move()}, {@link Mouse#down
   * Mouse.down()}, {@link Mouse#up Mouse.up()}, {@link Mouse#down
   * Mouse.down()} and {@link Mouse#up Mouse.up()}.
   *
   * @param x X coordinate relative to the main frame's viewport in CSS pixels.
   * @param y Y coordinate relative to the main frame's viewport in CSS pixels.
   * @since v1.8
