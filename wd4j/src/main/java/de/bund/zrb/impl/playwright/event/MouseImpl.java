...
import de.bund.zrb.impl.manager.WDInputManager;
import de.bund.zrb.impl.webdriver.command.request.parameters.input.sourceActions.PointerSourceAction;
import de.bund.zrb.impl.webdriver.command.request.parameters.input.sourceActions.SourceActions;
import de.bund.zrb.impl.webdriver.command.request.parameters.input.sourceActions.WheelSourceAction;
