...
import de.bund.zrb.support.EventDispatcherImpl;
import de.bund.zrb.websocket.WebSocketManager;
import support.Pages;
import support.ScriptHelper;
import de.bund.zrb.webdriver.command.response.WDBrowsingContextResult;
import de.bund.zrb.webdriver.command.response.WDScriptResult;
import de.bund.zrb.websocket.WDEventNames;
import de.bund.zrb.webdriver.event.WDScriptEvent;
import de.bund.zrb.webdriver.type.browsingContext.WDBrowsingContext;
import de.bund.zrb.webdriver.type.script.WDChannel;
import de.bund.zrb.webdriver.type.script.WDChannelValue;
import de.bund.zrb.webdriver.type.script.WDPrimitiveProtocolValue;
...
public class BrowserImpl implements Browser {
    ...
    private final EventDispatcherImpl dispatcher;
    ...
    public BrowserImpl(BrowserTypeImpl browserType, Process process, WebSocketImpl webSocketImpl) throws ExecutionException, InterruptedException {
        ...
        dispatcher = new EventDispatcherImpl(new PlaywrightEventMapper());
        WebSocketManager webSocketManager = new WebSocketManagerImpl(webSocketImpl, dispatcher);
