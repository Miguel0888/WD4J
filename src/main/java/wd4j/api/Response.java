...
public interface Response {
   ...
   * security-related headers, including cookie-related ones. You can use {@link Response#allHeaders
   ...
   * Response#allHeaders Response.allHeaders()}, header names are NOT lower-cased. Headers with
