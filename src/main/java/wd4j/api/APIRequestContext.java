 ...
 * with the browser context and can be accessed via {@link BrowserContext#request
 * BrowserContext.request()} or {@link Page#request Page.request()}. It is also possible to create
 * a new APIRequestContext instance manually by calling {@link APIRequest#newContext
 * APIRequest.newContext()}.
 *
 * <p> <strong>Cookie management</strong>
 *
 * <p> {@code APIRequestContext} returned by {@link BrowserContext#request BrowserContext.request()}
 * and {@link Page#request Page.request()} shares cookie storage with the corresponding {@code
 ...
 * calling {@link APIRequest#newContext APIRequest.newContext()}. Such {@code APIRequestContext}
