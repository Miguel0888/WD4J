 ...
 * Page#querySelector Page.querySelector()} method.
 *
 ...
 * JSHandle#dispose JSHandle.dispose()}. ElementHandles are auto-disposed when their origin frame
 * gets navigated.
 *
 * <p> ElementHandle instances can be used as an argument in {@link Page#evalOnSelector
 * Page.evalOnSelector()} and {@link Page#evaluate Page.evaluate()} methods.
 *
...
public interface ElementHandle extends JSHandle {
   ...
   * }</pre>
   *
   * <p> <strong>NOTE:</strong> This method does not work across navigations, use {@link Page#waitForSelector
