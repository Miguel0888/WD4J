 ...
 * Locator#contentFrame Locator.contentFrame()}, {@link Page#frameLocator
...
public interface FrameLocator {
  ...
  /**
   * @deprecated Use {@link Locator#first Locator.first()} followed by {@link
   * Locator#contentFrame Locator.contentFrame()} instead.
   *
   * @since v1.17
   */
  FrameLocator first();
  ...
  /**
   * @deprecated Use {@link Locator#last Locator.last()} followed by {@link
   * Locator#contentFrame Locator.contentFrame()} instead.
   *
   * @since v1.17
   */
  ...
  /**
   * @deprecated Use {@link Locator#nth Locator.nth()} followed by {@link
   * Locator#contentFrame Locator.contentFrame()} instead.
   *
   * @since v1.17
   */
