 ...
 * Page#locator Page.locator()} method.
 *
...
public interface Locator {
  ...
  class IsHiddenOptions {
    /**
     * @deprecated This option is ignored. {@link Locator#isHidden Locator.isHidden()} does not wait for the
  ...
  class IsVisibleOptions {
    /**
     * @deprecated This option is ignored. {@link Locator#isVisible Locator.isVisible()} does not wait for the
   ...
   *
   * <p> <strong>NOTE:</strong> {@link Locator#all Locator.all()} does not wait for elements to match the locator, and instead
   * immediately returns whatever is present in the page.When the list of elements changes dynamically, {@link Locator#all Locator.all()} will produce
   ...
   *
   * <p> The only difference between {@link Locator#evaluate Locator.evaluate()} and {@link
   * Locator#evaluateHandle Locator.evaluateHandle()} is that {@link
   * Locator#evaluateHandle Locator.evaluateHandle()} returns {@code JSHandle}.
   *
   * <p> If {@code expression} returns a <a
   * href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise'>Promise</a>, this method
   * will wait for the promise to resolve and return its value.
   ...
   * case, you can use {@link Locator#first Locator.first()} to only match one of them.
   * <pre>{@code
   ...
   * <p> <strong>Details</strong>
   *
   * <p> Focuses the element, and then uses {@link Keyboard#down Keyboard.down()} and {@link
  ...
  /**
   * <strong>NOTE:</strong> In most cases, you should use {@link Locator#fill Locator.fill()} instead. You only need to
   ...
   *
   * <p> To press a special key, like {@code Control} or {@code ArrowDown}, use {@link Locator#press
   * Locator.press()}.
   *
   * <p> <strong>Usage</strong>
   * <pre>{@code
