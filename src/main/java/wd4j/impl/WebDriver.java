...
import wd4j.impl.websocket.EventDispatcher;
 ...
 * It processes the incoming and outgoing messages and provides a facade for the WebDriver BiDi Modules.
 *
 ...
 *
 * For convenience, you can register event listeners for specific events, which are defined in the WebDriver BiDi API and
 * found here in the Enum WDEventName. It ist done by a event dispatcher, which requires a EventMapper to map the incoming
 * events to the corresponding event types of your choice.
 *
...
//    }
    ...
    private CallbackWebSocketServer callbackWebSocketServer; // A server to receive direct messages from the browser without WebDriver BiDi
