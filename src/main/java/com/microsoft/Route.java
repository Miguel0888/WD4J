...
/**
 * Whenever a network route is set up with {@link Page#route Page.route()} or {@link
 * BrowserContext#route BrowserContext.route()}, the {@code Route} object allows to handle the
 * route.
 *
